...
*/
	...
	ORG	25000;#8000	;старт программы ровно по центру памяти 48К
prg_start:
...
/*
emptytrd "7may.trd"
savetrd "7may.trd", "DEMO.C", prg_start, vt_end-prg_start
org 25000
inchob "demo.$B"
endb:
savetrd "7may.trd", "boot.B", 25000, endb-25000
*/
